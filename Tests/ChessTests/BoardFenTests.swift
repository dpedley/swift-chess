...
final class BoardFenTests: XCTestCase {
    func testBoardstartingFEN() {
        ...
        XCTAssertEqual(board.squares[1].piece?.UI, Chess.UI.Piece.blackKnight)
        XCTAssertEqual(board.squares[2].piece?.UI, Chess.UI.Piece.blackBishop)
        XCTAssertEqual(board.squares[3].piece?.UI, Chess.UI.Piece.blackQueen)
        XCTAssertEqual(board.squares[4].piece?.UI, Chess.UI.Piece.blackKing)
        XCTAssertEqual(board.squares[5].piece?.UI, Chess.UI.Piece.blackBishop)
        XCTAssertEqual(board.squares[6].piece?.UI, Chess.UI.Piece.blackKnight)
        XCTAssertEqual(board.squares[7].piece?.UI, Chess.UI.Piece.blackRook)
        XCTAssertEqual(board.squares[56].piece?.UI, Chess.UI.Piece.whiteRook)
        XCTAssertEqual(board.squares[57].piece?.UI, Chess.UI.Piece.whiteKnight)
        XCTAssertEqual(board.squares[58].piece?.UI, Chess.UI.Piece.whiteBishop)
        XCTAssertEqual(board.squares[59].piece?.UI, Chess.UI.Piece.whiteQueen)
        XCTAssertEqual(board.squares[60].piece?.UI, Chess.UI.Piece.whiteKing)
        XCTAssertEqual(board.squares[61].piece?.UI, Chess.UI.Piece.whiteBishop)
