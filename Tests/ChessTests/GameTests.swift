...
final class GameTests: XCTestCase {
    func testGameSetup() {
        ...
        XCTAssertEqual(game.board.FEN, "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR b KQkq - 0 1")
        game.nextTurn()
        TestWait(wait)
        XCTAssertEqual(game.round, 1)
        XCTAssertEqual(game.board.FEN, "rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2")
    }
