...
public extension Chess.Position {
    ...
    static let a4: Chess.Position = 32
    static let a5: Chess.Position = 24
    ...
    static let b4: Chess.Position = 33
    static let b5: Chess.Position = 25
    ...
    static let c4: Chess.Position = 34
    static let c5: Chess.Position = 26
    ...
    static let d4: Chess.Position = 35
    static let d5: Chess.Position = 27
    ...
    static let e4: Chess.Position = 36
    static let e5: Chess.Position = 28
    ...
    static let f4: Chess.Position = 37
    static let f5: Chess.Position = 29
    ...
    static let g4: Chess.Position = 38
    static let g5: Chess.Position = 30
    ...
    static let h4: Chess.Position = 39
    static let h5: Chess.Position = 31
    static let h6: Chess.Position = 23
